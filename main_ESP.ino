...
BlynkTimer timer;
char auth[] = "bcdWeoVpvlNsgz5hlpGwT8WXj0-_kMkp";
char ssid[] = "DANH";
char pass[] = "20071965";
#define FIREBASE_HOST "https://da1---fire-alarm-system-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "PUyYLqUO3GjCf5IUcFanZVY9KWGagXjen2BQNMHL" //Project settings -> Service accounts -> Database secrets -> Show
FirebaseData fbdo;
#define Rx 3
#define Tx 1
